            ...
            <form action="{{ route('admin.campanhas.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">
                        Selecione a lista de contatos que receberá esta campanha
                    </small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    @enderror
                    <small class="form-text text-muted">
                        Digite o conteúdo do email que será enviado aos contatos
                    </small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control @error('data_envio') is-invalid @enderror" 
                           id="data_envio" name="data_envio" value="{{ old('data_envio') }}">
                    @error('data_envio')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">
                        Deixe em branco para salvar como rascunho ou defina uma data/hora futura para agendar
                    </small>
                </div>
